...
export default function Home() {
    return (
        <>
            <div className='[background:radial-gradient(50vw_50vw_at_50%_65%,#170000_0%,_#130000_26%,_#000_100%),#000] md:[background:radial-gradient(25vw_25vw_at_65%_50%,#170000_0%,_#130000_26%,_#000_100%),#000]'>
                ...
                <div id='particles-js' className='w-full h-screen absolute top-0 z-[10]' />
            </div>
