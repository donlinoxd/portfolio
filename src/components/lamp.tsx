    ...
    return (
        ...
        >
            <div className='relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 '>
                <motion.div
                    initial={{ opacity: 0.5, width: '15rem', maxWidth: '40vw' }}
                    whileInView={{ opacity: 1, width: '30rem', maxWidth: '80vw' }}
                    transition={{
                        delay: 0.3,
                        duration: 0.8,
                        ease: 'easeInOut',
                ...
                ></motion.div>
                <motion.div
                    initial={{ width: '15rem', maxWidth: '40vw' }}
                    whileInView={{ width: '30rem', maxWidth: '80vw' }}
                    transition={{
                        delay: 0.3,
                        duration: 0.8,
                        ease: 'easeInOut',
